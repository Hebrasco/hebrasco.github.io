...
export default function AboutMe(): JSX.Element {
  return (
    <Container style={{ position: 'relative' }}>
      <div id={ROUTES.aboutMe.replace('/#', '')} className="anchor"></div>
      <h1>About me</h1>
      <Row>
        <Col xs={12} className="align-self-center">
          <p className="d-inline-block mt-2 mt-md-0">
            I have been working in app development since 2015 and have already
            implemented various projects for iOS and Android in small and large
            teams. I prefer programming for iOS, where I have already published
            an app.
          </p>
          <Row className="mb-3">
            <Col xs={12}>
